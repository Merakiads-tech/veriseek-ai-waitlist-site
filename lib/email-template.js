...
export function buildThankYouEmail({ source = 'hero_cta' } = {}) {
  ...
  const text = [
    ...
    '',
    'In the meantime, learn more at https://veriseek.ai',
    '',
    '— The VeriSeek team',
    'Truth you can act on.',
    '',
    "You're receiving this because you joined the waitlist at waitlist.veriseek.ai.",
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#FFFFFF;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,48,73,0.08);">
            ...
            <tr>
              <td align="center" style="padding:8px 40px 36px 40px;">
                <a href="https://veriseek.ai" style="display:inline-block;background:#01B5B6;color:#FFFFFF;text-decoration:none;font-size:14px;font-weight:600;padding:14px 28px;border-radius:999px;">
                  Visit veriseek.ai
                </a>
              </td>
            </tr>
            ...
            <tr>
              <td style="background:#F2FBFB;border-top:1px solid #D7EDEE;padding:20px 36px;" align="center">
                ...
                <p style="margin:0;font-size:11px;color:#94A3B8;line-height:1.6;">
                  You're receiving this because you joined the waitlist at waitlist.veriseek.ai.<br/>
                  If this wasn't you, you can safely ignore this email.
                </p>
              </td>
            </tr>
